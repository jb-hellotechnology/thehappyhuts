...
<div class="text booking">
	<div class="restrict">
        ...
        <form method="post" action="/book/checkout/<?php echo $_POST['unit']; ?>">
 		<?php
          ...
          if($maxNights==0){
	          ...
	          echo '<h2>Sorry, this date is no longer available</h2><p><a href="/book">Click here to choose a different date</a></p>';
