		...
		<script>
			function startTimer(duration, display) {
			    ...
			    setInterval(function () {
			        ...
			        if (--timer < 0) {
			            window.location.replace('/book/incomplete');
			        }
			    }, 1000);
			}
...
-->
          ...
          <script type="text/javascript">
	          ...
	          function setAmount(){
		          $.post( "/book/get-price-value?r=" + Math.random(), { unit: "<?php echo $unit; ?>", arrival: "<?php echo $arrivalDate; ?>", nights: <?php echo $nights; ?> }).done(function( data ) {
	          ...
	          function applyVoucher(){
		      	...
		      	$.post( "/book/apply-voucher-code?" + Math.random(), { voucherCode: pVoucherCode, reference: pReference }).done(function( data ) {
	            	alert(data);
	            	getPrice();
	            	setAmount();
	            });
